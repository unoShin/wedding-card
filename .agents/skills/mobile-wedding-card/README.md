...
포함할 섹션 번호 입력 (쉼표 구분, 엔터 누르면 전체 선택) [1,2,3,4,5,6,7,8]: 
```
...
6. **GitHub Pages 배포**:
   - `./deploy.sh` 실행 (누구나 무료로 영구 호스팅 가능)
