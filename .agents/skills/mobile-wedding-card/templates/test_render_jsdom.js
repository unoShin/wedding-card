    ...
    if (isPost) {
      ...
      return Promise.resolve({
        ...
        json: () => Promise.resolve({
          result: 'success',
          data: [
            { name: "친구 일동", date: "2026-06-14T12:00:00.000Z", message: "결혼 진심으로 축하해! 평생 행복하고 예쁘게 잘 살아라!! ♥" },
            { name: "직장 동료", date: "2026-06-12T09:00:00.000Z", message: "두 분의 결혼을 진심으로 축하드립니다. 인생의 새로운 2막을 응원합니다." },
            { name: "혜원", date: "2026-06-10T06:00:00.000Z", message: "언니! 너무너무 축하해!! 당일에 세상에서 제일 예쁠 신부 기대할게!" }
          ]
        })
      });
    }
